...
let closeL9Btn = document.querySelector('#closeL9Btn')

locusnine.addEventListener('click', () => {
  l9Modal.style.display = 'block'
})

closeL9Btn.addEventListener('click', () => {
  l9Modal.style.display = 'none'
})

document.addEventListener('DOMContentLoaded', function (event) {
  // ViewPort()
  // array with texts to type in typewriter
  var dataText = ["A Cinephile", "A Fitness Enthusiast", "A Developer"]
